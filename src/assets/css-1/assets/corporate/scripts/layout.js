...
// Ensure toastr container is always visible above the fixed header
ensureToastrVisibility: function() {
    // Adjust toastr container style if needed
    jQuery('.toast-container').css({
...
initialize: function() {
    this.initFixHeaderWithPreHeader();
    this.initNavScrolling();
    this.ensureToastrVisibility();
},
